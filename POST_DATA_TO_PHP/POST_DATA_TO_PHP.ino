...
const  char* ssid      = "www.interactiverobotics.club";      //masukkan ssid
const  char* password  = "cilibur2019";  //masukkan password
String namadevice      = "punyaila"; //isi dengan nama tanpa spasi
...
void loop() {
  ...
  if (WiFi.status() == WL_CONNECTED) {
    HTTPClient http;
    http.begin("http://192.168.1.8/irciot/data-api.php?namadevice=" + String(namadevice) + 
    "&suhu=" + String(getsuhu) + 
